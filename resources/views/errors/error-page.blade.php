@php
    ...
    $message = $message ?? 'Halaman yang Anda cari tidak tersedia.';
...
<head>
    ...
    <title>{{ $statusCode }} | Support SAP</title>
    <style>
        :root {
            color-scheme: light;
            --ink: #1f2b3a;
...
<body>
    <main class="error-card" aria-labelledby="error-title">
        ...
        <div class="error-card__body">
            ...
            <p class="message">
                {{ $message }} Silakan kembali ke halaman sebelumnya atau beranda untuk melanjutkan pekerjaan.
            </p>
            <div class="actions">
                <button
